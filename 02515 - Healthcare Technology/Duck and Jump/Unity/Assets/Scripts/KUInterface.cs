...
//
//        //set up image memory
//        seqTex = new byte[ImageWidth * ImageHeight * 4];
//        cols = new Color32[ImageWidth * ImageHeight];
//        texture = new Texture2D(ImageWidth, ImageHeight);
//
//        seqDepth = new byte[ImageWidth * ImageHeight * 2];
//        dcols = new Color32[ImageWidth * ImageHeight];
//        depthImg = new Texture2D(ImageWidth, ImageHeight);
//        depth = new short[ImageWidth][];
//        for (int i = 0; i < depth.Length; i++) {
//            depth[i] = new short[ImageHeight];
//        }
//    }
//
//
...
//
//        int size = 0;
//		var bytes = ImageWidth * ImageHeight * 4;
//
...
//                {
//                    depth[ImageWidth - x - 1][ImageHeight - y - 1] = BitConverter.ToInt16(seqDepth, (x*2)+(y*ImageWidth*2));
//                }
//            }
//
...
//                    for (int y = 0; y < ImageHeight; y++)
//                    {
//                        dcols[x + (y * ImageWidth)] = new Color32((byte)depth[x][y], (byte)depth[x][y], (byte)depth[x][y], 255);
//                    }
//                }
//
//                //set texture
...
//            //scaled to half-res
//            GUI.DrawTexture(new Rect(600, 50, ImageWidth / 2, ImageHeight / 2), texture, ScaleMode.ScaleToFit, false);
//        }
//
//        if (displayDepthImage && useDepth && NUIisReady) {
//            //scaled to half-res
//            GUI.DrawTexture(new Rect(600, 300, ImageWidth / 2, ImageHeight / 2), depthImg, ScaleMode.ScaleToFit, false);
//        }
//    }
//
//
