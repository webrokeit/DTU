...
\hline
\multicolumn{1}{|c|}{\textbf{Test}} & \multicolumn{1}{c|}{\textbf{Need}} & \multicolumn{1}{c|}{\textbf{Nice}} & \multicolumn{1}{c|}{\textbf{Status}} \\
\endfirsthead

\multicolumn{4}{c}%
{{\bfseries \tablename\ \thetable{} -- continued from previous page}} \\
\hline
\multicolumn{1}{|c|}{\textbf{Requirement}} & \multicolumn{1}{c|}{\textbf{Need}} & \multicolumn{1}{c|}{\textbf{Nice}} &\multicolumn{1}{c|}{\textbf{Status}} \\
\endhead
...
%Gesture recognition & Gestures are recognized regardless of the size of the player with code modifications & Gestures are recognized regardless of the size of the player without code modifications & Nice achieved \\ \hline
\end{longtable}
\end{center}
