...
\begin{figure}[H]
NEED GRAPH...!
\caption[Graph depicting joint tracking of KneeLeft and KneeRight]{Graph showing the positions of KneeLeft and KneeRight during a session where the player jumped.}
\end{figure}
...
\chapter{Test}
Some introductory text to the tests.
