...
\section{Scope}
We will focus on the fault-tolerant features of the cloud computing architecture within the two selected cloud systems (Amazon Web Services and Google Cloud Platform).
