...
$$\mathrm{\textbf{P}} = \left(
\begin{array}{c c c c}
	0 & \frac{2}{5} & 0 & \frac{3}{5}\\[0.15cm]
	0 & \frac{1}{2} & \frac{1}{2} & 0\\[0.15cm]
	\frac{2}{5} & 0 & \frac{1}{5} & \frac{2}{5}\\[0.15cm]
	0 & 0 & 1 & 0
\end{array}
\right)$$
...
\\
PRISM outputs the following steady state solution for the encoded DTMC:
\begin{lstlisting}[style=logoutput]
0:(0)=0.1694916167456058
1:(1)=0.1355931954330166
2:(2)=0.42372867450100926
3:(3)=0.2711865133203683
\end{lstlisting}
The above matches the calculated steady state solution from A2.1c. \Phi
