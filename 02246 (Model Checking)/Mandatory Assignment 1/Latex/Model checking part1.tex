...
\begin{description}
	\item[A2.2a) $EX \; EF \; \Phi$ and $EF \; EX \; \Phi$:] They are equal\\
	...
	\item[A2.2b) $AX \; AF \; \Phi$ and $AF \; AX \; \Phi$:] They are equal\\
	...
	\end{figure}
	In Figure A2.2b the transition system $M_1$ satisfies both formulae. Transition system $M_2$ will not satisfy any of the formulae.
	
	\item[A2.2c) $AG \; EF \; \Phi$ and $EF \; AG \; \Phi$:] The first formulae implies the second formulae $\left(AG \; EF \; \Phi \Rightarrow EF \; AG \; \Phi\right)$.\\
	...
	\item[A2.2d) $AG \; (\Phi_1 \wedge \Phi_2)$ and $(AG \; \Phi_1) \wedge (AG\;\Phi_2)$:] They are equal\\
